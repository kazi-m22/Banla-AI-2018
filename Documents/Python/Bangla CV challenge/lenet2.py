...
def my_model(img_size=28, channels=1):
    ...
    # model.add(Conv2D(16, (5, 5), input_shape=input_shape,activation='elu', padding='same'))
    # model.add(Conv2D(16, (5, 5), activation='elu', padding='same'))
    # model.add(MaxPooling2D(pool_size=(2, 2)))

    model.add(Conv2D(20, (5, 5), input_shape=input_shape, activation='relu', padding='same'))
...
create_submission(predictions=labels,keys=keys,path='misbah_sub10.csv')